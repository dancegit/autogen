...
base_image = (modal.Image
    ...
    .run_commands(
        ...
        "npm install react react-dom @reactflow/core --no-fund --no-audit --loglevel verbose --force || (echo 'npm install failed' >&2 && cat /root/.npm/_logs/*-debug.log && exit 1)",
        "npm install react react-dom @reactflow/core --no-fund --no-audit --loglevel verbose --force || (echo 'Second npm install attempt failed' >&2 && cat /root/.npm/_logs/*-debug.log && exit 1)",

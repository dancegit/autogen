...
image = (
    ...
    .run_commands(
        ...
        "/root/autogen/python/.venv/bin/pip install /root/autogen/python/packages/autogen-core",
        "/root/autogen/python/.venv/bin/pip install /root/autogen/python/packages/autogen-ext",
        "/root/autogen/python/.venv/bin/pip install /root/autogen/python/packages/autogen-magentic-one",
